...
GoalGenerator=sm.Parallel(ffSkeleton.FollowFigure(squarePoints),sm.Wire())
dmtp=dynamicMoveToPointSkeleton.DynamicMoveToPoint()
mySM = sm.Switch(condition,sm.Constant(io.Action(fvel=0,rvel=0)),sm.Cascade(GoalGenerator,dmtp))
